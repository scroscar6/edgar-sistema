...
class api_Settings
{
	const XML_FILE_NAME = '/settings/settings.php';
	...
	public function SaveToXml()
	{
		...
		copy($this->sPath.api_Settings::XML_FILE_NAME, $this->sPath.api_Settings::XML_FILE_NAME.'.bak');
	...
	protected function initDefaultValues()
	{
		$this->aMap = array(
			...
			'Common/InvitationEmail' => array('', 'string'),
