...
$URLBase = $ObjConexion->URLBase();
$baseUrl = $URLBase.'/media/multimedia/';
...
$opts = array(
	...
	'roots' => array(
		array(
			...
			'path'          => '../../../../media/multimedia/',                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/../../../../media/multimedia/', // URL to files (REQUIRED)
