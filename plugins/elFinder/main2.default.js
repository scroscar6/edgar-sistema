...
(function(){
	var // jQuery and jQueryUI version
		...
		opts = {
			url : 'plugins/elFinder/php/connector.minimal.php', // connector URL (REQUIRED)
			cssAutoLoad  : [
				'plugins/elFinder/themes/Material/theme.css'
			],
			height:700,
	...
	require.config({
		...
		paths : {
			...
			'elfinder' : '../plugins/elFinder/js/elfinder.min',
			'elfinder.lang': [
				'../plugins/elFinder/js/i18n/elfinder.'+lang,
