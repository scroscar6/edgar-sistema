...
print("<pre>".print_r($datosCiclo,true)."</pre>");
exit();
*/
...
if ($value->dato_deuda == 1) {
    ...
    $grafico_barras = '<img src="http://localhost:8080/sistema_edgar/was/plugins/jp/src/grafico/grafico.php?idciclo='.$idciclo.'&idrecibo='.$value->id_recibo.'" width="360px">';
